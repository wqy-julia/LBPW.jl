...
function select_best(crit::MaxUCB, h_node::LBPWTreeObsNode, rng)
    tree = h_node.tree
    h = h_node.node
...
function select_best(crit::MaxQ, h_node::LBPWTreeObsNode, rng)
    tree = h_node.tree
    h = h_node.node
...
function select_best(crit::MaxTries, h_node::LBPWTreeObsNode, rng)
    tree = h_node.tree
    h = h_node.node
    best_node = first(tree.tried[h])
